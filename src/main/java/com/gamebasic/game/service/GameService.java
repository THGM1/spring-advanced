...
public class GameService {
    ...
    public GameDetailResponse updateProgress(Long gameId, ProgressRequest request) {
        ...
        if(game.isFinished()) throw new ResponseStatusException(HttpStatus.CONFLICT, "이미 끝난 게임입니다. id =" + game.getId());
    ...
    @Transactional
    public RenameResponse renameGame(Long gameId, RenameRequest request){
        Game game = findGame(gameId);
